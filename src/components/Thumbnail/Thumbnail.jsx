  ...
  return (
    <div className="thumbnail">
      <div className={`thumbnail__container ${infor ? infor : ""}`}>
        <div className="thumbnail__img" onClick={handleGetPost}>
          <div
            className="thumbnail__img__container"
            style={{ backgroundImage: `url(${post.imgPost || bgEmty})` }}
          >
        ...
        <div className="thumbnail__desc">
          ...
          <div className="thumbnail__inter">
            <div onClick={handleGetUser} className="thumbnail__inter__infor">
              <h4>
                by <span>{post.user.username}</span> since{" "}
